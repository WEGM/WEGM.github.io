!function(t, e) {
    var o = function(t) {
      ...
      , n = Math.random()
      , a = "//game.gtimg.cn/"
      , s = a + "images/js/topfiles/ost1410/"
    ...
    r = {
        ...
        wrap: function() {
            ...
            return l.loadCSS(s + "ost.min.css?ran=" + n, "link"),
            t.className = "ost_box ost_bg",
            t.id = "ost_box",
            t.style.cssText = "position:absolute;",
            t.innerHTML = '<ul class="ost_inner ost_lsn"><li class="ost_logo ost_h40 ost_fl ost_bg"><a href="//game.qq.com/' + o + ' target="_blank" class="ost_blnk ost_hdn" title="\u817e\u8baf\u6e38\u620flogo">\u817e\u8baf\u6e38\u620flogo</a></li><li id="ost_g" class="ost_ad ost_h40 ost_fl"></li><li class="ost_total ost_ml10 ost_fr"><h3 class="ost_czsh ost_h40" ><a target="_blank" href="https://jiazhang.qq.com/jz/home.html?ADTAG=gamepcbanner">\u6210\u957f\u5b88\u62a4\u5e73\u53f0</a></h3><h3 class="ost_title ost_h40" id="ost_t">\u817e\u8baf\u6e38\u620f\u6392\u884c\u699c<i class="ost_icon_arrow ost_bg"></i><sup class="ost_icon_reddot" id="ost_rank_v"></sup></h3><div class="ost_pop" id="ost_p"></div></li><li class="ost_fr ost_log ost_bg" id="ost_log"></li></ul><div id="ost_d" class="ost_big"></div>',
                ...
                window.tencentO2AdCallback1 = function(t) {
                    if (t) {
                        ...
                        e.onmouseover = n.onmouseover = function() {
                            ...
                            a || (n.innerHTML = '<a href="' + l + '" target="_blank"><img class="ost_nb" src="' + i + '" width="' + t.width + '" height="' + t.height + '" alt=""/></a>'),
                            a = !0
                        }
                        ,
            ...
            return l.loadJS("//game.qq.com/act/media/20120601457/data.js?ran=" + n, function() {
                ...
                if (a && s) {
                    ...
                    var u = null
                      ...
                      , f = "?";
                    h.indexOf("?") != -1 && (f = "&");
                    var p = '<div class="ost_bpb"><h3 class="ost_t ost_bg"><a href="javascript:bps(false);" class="ost_bpc ost_fr ost_bg ost_hdn">\u5173\u95ed</a>\u817e\u8baf\u6e38\u620f\u7cbe\u54c1\u63a8\u8350</h3><p style="background-image:url(' + _[0] + ')" class="ost_p ost_bg"><a href="' + h + f + 'ADTAG=media.free.gamewebhot.ad" class="ost_lnk ost_hdn" target="_blank">\u70b9\u51fb\u8fdb\u5165</a></p></div>'
        ...
        rankEffct: function() {
            ...
            var e = o("ost_p")
              , a = o("ost_t")
              , s = "//tiem-cdn.qq.com/html/mms/nativeads/game_rank.html?rd=" + n;
            return l.eventUtil.addListener(a, "mouseover", function(n) {
                a.className = "ost_title ost_h40 ost_title_hover",
                e.innerHTML = '<iframe id="gameRank" name="gameRank" allowTransparency="true" style="background:transparent;" src="' + s + '" width="700" height="465" frameBorder="0" scrolling="no"></iframe></div>',
            ...
            l.eventUtil.addListener(e, "mouseover", function(t) {
                a.className = "ost_title ost_h40 ost_title_hover",
                e.style.display = "block",
                l.eventUtil.stopPropagation(t)
            }),
            l.eventUtil.addListener(a, "mouseout", function(t) {
                e.style.display = "none",
                a.className = "ost_title ost_h40",
                l.Cookie.clear("bRankChanged"),
                l.eventUtil.stopPropagation(t)
            }),
            l.eventUtil.addListener(e, "mouseout", function(t) {
                e.style.display = "none",
                a.className = "ost_title ost_h40",
                l.Cookie.clear("bRankChanged"),
                l.eventUtil.stopPropagation(t)
