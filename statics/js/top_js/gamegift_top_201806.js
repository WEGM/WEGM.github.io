!function(t, e) {
	...
	r = {
		...
		wrap: function() {
			...
			return l.loadCSS(s + "css/ost.css?ran=" + n, "link"),
			t.className = "ost_box",
			t.id = "ost_box",
			t.style.cssText = "position:absolute;",
			t.innerHTML = '<ul class="ost_inner ost_lsn"><li class="ost_logo ost_h40 ost_fl"><a href="//www.gamegift.cn/" target="_blank" class="ost_blnk ost_hdn" title="\u817e\u8baf\u6e38\u620flogo">\u817e\u8baf\u6e38\u620flogo</a></li><li id="ost_g" class="ost_ad ost_h40 ost_fl"></li><li class="ost_total ost_ml10 ost_fr"><h3 class="ost_czsh ost_h40" ><a target="_blank" href="//www.gamegift.cn/ssologin">\u540E\u53F0\u767B\u5F55</a></h3><h3 class="ost_title ost_h40" id="ost_t">\u6e38\u620f\u6392\u884c\u699c<i class="ost_icon_arrow ost_bg"></i><sup class="ost_icon_reddot" id="ost_rank_v"></sup></h3><div class="ost_pop" id="ost_p"></div></li><li class="ost_fr ost_log ost_bg" id="ost_log"></li></ul><div id="ost_d" class="ost_big"></div>',
