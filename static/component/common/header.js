...
// 			</div>
// 			<form class="header-search fl right" id="header-search" method="get" action="/search">
...
// 				<button class="header-submit icon-search fl"></button>
