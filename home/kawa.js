...
function switchsound()
{
    ...
    if(au.paused)
    {
        bplay = 1;
        au.play();
        ai.src = "home/music_note_big.png";
...
function create_music()
{
    ...
    bg_htm = "<img id='sound_image' src='home/music_note_big.png'>";
...
function make_text_animation()
{
    ...
    if(kawa_data.mode == 'up')
    {
        ...
        mask.style.webkitMaskImage = 'url(home/shu.png)';
    ...
    else if(kawa_data.mode == 'left')
    {
        ...
        mask.style.webkitMaskImage = 'url(home/bg6.png)';
        mask.style.webkitMaskSize  = 'contain';
        mask.style.zIndex          = 1;
    }
